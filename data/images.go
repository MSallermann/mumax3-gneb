...
// func NewSlice(size int) *Image {

// 	ptr: = unsafe.Pointer(&(make([]float32, size)[0]))
// 	return SliceFromPtrs(size, CPUMemory, ptr)
// }

// func SliceFromArray(data []float32, size int) *Image {
...
// func NilSlice(size int) *Image {
// 	return SliceFromPtrs(size, GPUMemory, make(unsafe.Pointer, 1))
// }

// // Internal: construct a Slice using bare memory pointers.
// func SliceFromPtrs(size int, memType int8, ptr unsafe.Pointer) *Image {

// 	util.Argument(len(ptr)> 0 && size > 0)
// 	s := new(Image)
// 	s.ptr = make(unsafe.Pointer, 1)
// 	s.size = size
// 	s.ptr = ptr
// 	s.memType = memType
// 	return s
...
// // func (s *Slice) Image() int {
// // 	return s.noi
// // }

// // Comp returns a single component of the Slice.
// func (s *Image) Comp(i int) *Image {
// 	sl := new(Image)
// 	sl.ptr = make(unsafe.Pointer, 1)
// 	sl.size = s.size
...
// func (s *Image) DevPtr(component int) unsafe.Pointer {
// 	if s == nil {
// 		return nil
// 	}
// 	if !s.GPUAccess() {
// 		panic("Image not accessible by GPU")
// 	}
