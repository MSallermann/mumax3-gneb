...
// CUDA handle for gneb_addexchange kernel
var gneb_addexchange_code cu.Function

// Stores the arguments for gneb_addexchange kernel invocation
type gneb_addexchange_args_t struct {
...
// Stores the arguments for gneb_addexchange kernel invocation
var gneb_addexchange_args gneb_addexchange_args_t

func init() {
	// CUDA driver kernel call wants pointers to arguments, set them up once.
	gneb_addexchange_args.argptr[0] = unsafe.Pointer(&gneb_addexchange_args.arg_Bx)
	gneb_addexchange_args.argptr[1] = unsafe.Pointer(&gneb_addexchange_args.arg_By)
	gneb_addexchange_args.argptr[2] = unsafe.Pointer(&gneb_addexchange_args.arg_Bz)
	gneb_addexchange_args.argptr[3] = unsafe.Pointer(&gneb_addexchange_args.arg_mx)
	gneb_addexchange_args.argptr[4] = unsafe.Pointer(&gneb_addexchange_args.arg_my)
	gneb_addexchange_args.argptr[5] = unsafe.Pointer(&gneb_addexchange_args.arg_mz)
	gneb_addexchange_args.argptr[6] = unsafe.Pointer(&gneb_addexchange_args.arg_Ms_)
	gneb_addexchange_args.argptr[7] = unsafe.Pointer(&gneb_addexchange_args.arg_Ms_mul)
	gneb_addexchange_args.argptr[8] = unsafe.Pointer(&gneb_addexchange_args.arg_aLUT2d)
	gneb_addexchange_args.argptr[9] = unsafe.Pointer(&gneb_addexchange_args.arg_regions)
	gneb_addexchange_args.argptr[10] = unsafe.Pointer(&gneb_addexchange_args.arg_wx)
	gneb_addexchange_args.argptr[11] = unsafe.Pointer(&gneb_addexchange_args.arg_wy)
	gneb_addexchange_args.argptr[12] = unsafe.Pointer(&gneb_addexchange_args.arg_wz)
	gneb_addexchange_args.argptr[13] = unsafe.Pointer(&gneb_addexchange_args.arg_Nx)
	gneb_addexchange_args.argptr[14] = unsafe.Pointer(&gneb_addexchange_args.arg_Ny)
	gneb_addexchange_args.argptr[15] = unsafe.Pointer(&gneb_addexchange_args.arg_Nz)
	gneb_addexchange_args.argptr[16] = unsafe.Pointer(&gneb_addexchange_args.arg_noi)
	gneb_addexchange_args.argptr[17] = unsafe.Pointer(&gneb_addexchange_args.arg_PBC)
	gneb_addexchange_args.argptr[18] = unsafe.Pointer(&gneb_addexchange_args.arg_GNEB)
	gneb_addexchange_args.argptr[19] = unsafe.Pointer(&gneb_addexchange_args.arg_JZ)
}

// Wrapper for gneb_addexchange CUDA kernel, asynchronous.
func k_gneb_addexchange_async(Bx unsafe.Pointer, By unsafe.Pointer, Bz unsafe.Pointer, mx unsafe.Pointer, my unsafe.Pointer, mz unsafe.Pointer, Ms_ unsafe.Pointer, Ms_mul float32, aLUT2d unsafe.Pointer, regions unsafe.Pointer, wx float32, wy float32, wz float32, Nx int, Ny int, Nz int, noi int, PBC byte, GNEB byte, JZ float32, cfg *config) {
	if Synchronous { // debug
		Sync()
		timer.Start("gneb_addexchange")
	}

	gneb_addexchange_args.Lock()
	defer gneb_addexchange_args.Unlock()

	if gneb_addexchange_code == 0 {
		gneb_addexchange_code = fatbinLoad(gneb_addexchange_map, "gneb_addexchange")
	}

	gneb_addexchange_args.arg_Bx = Bx
	gneb_addexchange_args.arg_By = By
	gneb_addexchange_args.arg_Bz = Bz
	gneb_addexchange_args.arg_mx = mx
	gneb_addexchange_args.arg_my = my
	gneb_addexchange_args.arg_mz = mz
	gneb_addexchange_args.arg_Ms_ = Ms_
	gneb_addexchange_args.arg_Ms_mul = Ms_mul
	gneb_addexchange_args.arg_aLUT2d = aLUT2d
	gneb_addexchange_args.arg_regions = regions
	gneb_addexchange_args.arg_wx = wx
	gneb_addexchange_args.arg_wy = wy
	gneb_addexchange_args.arg_wz = wz
	gneb_addexchange_args.arg_Nx = Nx
	gneb_addexchange_args.arg_Ny = Ny
	gneb_addexchange_args.arg_Nz = Nz
	gneb_addexchange_args.arg_noi = noi
	gneb_addexchange_args.arg_PBC = PBC
	gneb_addexchange_args.arg_GNEB = GNEB
	gneb_addexchange_args.arg_JZ = JZ

	args := gneb_addexchange_args.argptr[:]
	cu.LaunchKernel(gneb_addexchange_code, cfg.Grid.X, cfg.Grid.Y, cfg.Grid.Z, cfg.Block.X, cfg.Block.Y, cfg.Block.Z, 0, stream0, args)

	if Synchronous { // debug
		Sync()
		timer.Stop("gneb_addexchange")
	}
}

// maps compute capability on PTX code for gneb_addexchange kernel.
var gneb_addexchange_map = map[int]string{0: "",
	50: gneb_addexchange_ptx_50}

// gneb_addexchange PTX code for various compute capabilities.
const (
	gneb_addexchange_ptx_50 = `
.version 7.5
.target sm_50
.address_size 64
